...
export default function NotFound() {
  ...
  // If it's a library route, show library 404
  if (isLibrary) {
    return (
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            >
              <h3 className="text-lg font-bold text-on-surface mb-4">אולי תרצה לבקר ב:</h3>
              <div className="grid sm:grid-cols-2 gap-3 text-right">
                <Link href="/#download" className="p-3 bg-surface-variant hover:bg-surface rounded-lg transition-colors flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary">download</span>
                  <span>הורדת התוכנה</span>
                </Link>
                <Link href="/library" className="p-3 bg-surface-variant hover:bg-surface rounded-lg transition-colors flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary">library_books</span>
                  <span>ספריית אוצריא</span>
                </Link>
                <Link href="/faq" className="p-3 bg-surface-variant hover:bg-surface rounded-lg transition-colors flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary">help</span>
                  <span>שאלות נפוצות</span>
                </Link>
                <Link href="/about" className="p-3 bg-surface-variant hover:bg-surface rounded-lg transition-colors flex items-center gap-2">
